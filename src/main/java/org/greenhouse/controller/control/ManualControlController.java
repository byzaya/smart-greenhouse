...
public class ManualControlController {
  ...
  @Operation(summary = "Вкл вентилятор", description = "Вкл вентилятор в теплице по ее id")
  @PostMapping("/{greenhouseId}/fan/on")
  public void fanOn(@PathVariable Long greenhouseId) {
    manualControl.fanOn(greenhouseId);
  }

  @Operation(summary = "Выкл вентилятор", description = "Выкл вентилятор в теплице по ее id")
  ...
  @Operation(summary = "Закрыть окно", description = "Открыть окно наполовину в теплице по ее id")
  ...
  @Operation(summary = "Выкл полив", description = "Выкл полив грядки по ее id")
